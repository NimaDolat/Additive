...
numExp = 40; %we don't add one anymore since we just check the best observed
...
address = '/home/stats/dolatnin/Phase2/5. Greedy/Data/Griewank 6D';
FuncName = 'Griewank';
% FuncName = 'Ackley';
...
parfor iSim = 1:nsim
    ...
    [DATA, reg, NumPartitionComponent, Scale, BW] = AdaptiveGreedyPolicyObservedReg(boundPara, noise2, numExp, updateIteration, realOpt, InitScale, InitBW, InitDATA, FuncName);
...
filename = ['FullAdaptiveUCBObservedReg', FuncName, 'UpFreq', sprintf('%d',updateIteration), '.mat'];
...
address = '/home/stats/dolatnin/Phase2/5. Greedy/Data/Ackley';
...
address = '/home/stats/dolatnin/Phase2/5. Greedy/Data/Styblinski';
...
address = '/home/stats/dolatnin/Phase2/5. Greedy/Data/Hartmann6';
