...
parfor iSim = 1:nsim
    ...
    [DATA, reg, Scale, BW] = RandomSelection12D(funcMu, boundPara, noise2, oneExtExp, updateIteration, realOpt, InitScale, InitBW, InitDATA, FuncName);
    Allscales(iSim,:) = Scale;
    Allbws(iSim,:) = BW;
    AllDATA{iSim}= DATA;
    Allreg(iSim,:) = reg;
end
filename = ['Rand12D', FuncName, 'UpFreq', sprintf('%d',updateIteration), '.mat'];
